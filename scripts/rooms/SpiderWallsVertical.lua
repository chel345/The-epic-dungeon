...
map = function()
return {
9, 9, 9, 9, 0, 9, 9, 9, 9, 9, 4, 4, 9, 0, 9, 4, 4, 9, 9, 4, 4, 9, 0, 9, 4, 4, 9, 9, 4, 4, 9, 0, 9, 4, 4, 9, 9, 4, 4, 9, 0, 9, 4, 4, 9, 9, 4, 4, 9, 0, 9, 4, 4, 9, 9, 4, 4, 9, 0, 9, 4, 4, 9, 9, 4, 4, 9, 0, 9, 4, 4, 9, 9, 9, 9, 9, 0, 9, 9, 9, 9
}
end,
getHidth = function()
return 9
...
local mob = RPD.MobFactory:mobByName("ShadowWallSpider")
local level = RPD.Dungeon.level
mob:setPos(k)
level:spawnMob(mob)
end

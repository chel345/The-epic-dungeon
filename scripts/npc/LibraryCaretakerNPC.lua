...
EPD.showQuestWindow(self, RPD.textById("LibraryCaretakerNPC_Phrase1"))
storage.put("interact",true)
return
end
if RPD.Dungeon.hero:getBelongings():getItem("ScrollOfTeleportation") then
EPD.showQuestWindow(self, RPD.textById("LibraryCaretakerNPC_Phrase2"))
...
RPD.glog(RPD.textById("LibraryCaretakerNPC_Phrase3")..wand:name())
...
EPD.showQuestWindow(self, RPD.textById("LibraryCaretakerNPC_Phrase4"))
end
end
})

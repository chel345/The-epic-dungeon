 ...
 desc  = function ()
        return {
           image     = 6,
            ...
            info      = "В этой книге находятся заклинания для призыва великих сущностей, написанные на древнем языке прищывателей. Ты, однако, способен прочесть лишь одно заклинание- Призыв клыков. Это заклинание создаёт множество клыков, направленных в одну сторону. Призыв каждого расходует 1 единицу маны.",
            stackable = false,
            upgradable    = true,
         equipable     = "left_hand",
             price     = 200,
